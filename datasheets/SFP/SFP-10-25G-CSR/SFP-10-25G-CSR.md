...
## MODULETEK: SFP-10-25G-CSR

10.3125/25.78Gb/s SFP Short Wavelength （ 850nm ） Transceiver

## SFP-10-25G-CSR Overview

SFP-10-25G-CSR  optical  transceivers  are  based  on  25G  Ethernet  IEEE  802.3  standard  and support 10G and 25G dual rate applications. They are compliant with SFF-8402 、 SFF-8432 and SFF8472, providing a fast and reliable interface for 25G Ethernet applications. The product implements the digital diagnostics required by the SFF-8472 via a 2-wire serial bus.

## Product Features

- Operating data rate support 25.78Gb/s with CDR engaged mode
- Operating data rate support 10.3125Gb/s with CDR bypassed mode
- Compliant with IEEE 802.3
- Compliant with SFF-8402
- Compliant with SFF-8432
- Compliant with SFF-8472
- Internal CDR on both Transmit and Receive channel
...
- 25GBASE-SR Ethernet
- 10GBASE-SR Ethernet
- eCPRI Wireless Networks

![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000001_61e15d607434e9578e20c09ae6e23f54fd425012c2d6dfe6dcfd2719231db534.png)
...
|----------------|--------------|------------------------------------------------------|------------------|
| SFP-10-25G-CSR | M600603      | 10/25GBASE-SRSFP850nmLC Connectors, with DOMfunction | Black            |
...
| Supply Current        | I CC     |        | 145   | 290    | mA     |         3 |
...
| Parameter                                            | Symbol   | Min   |     Typ | Max        | Unit   |   Remarks |
|------------------------------------------------------|----------|-------|---------|------------|--------|-----------|
| Data rate@25.78Gb/s                                  | DR       |       | 25.78   |            | Gb/s   |         1 |
| Data rate@10.3Gb/s                                   | DR       |       | 10.3125 |            | Gb/s   |         1 |
| Bit error rate@25.78Gb/s                             | BER      |       |         | 5x 10 - 5  |        |         2 |
| Bit error rate@10.3Gb/s                              | BER      |       |         | 1x 10 - 12 |        |         3 |
| OM3 multimode fiber (bandwidth 2000MHz*km)@25.78Gb/s | L        |       |         | 300        | M      |         4 |
| OM3 multimode fiber (bandwidth 2000MHz*km)@10.3Gb/s  | L        |       |         | 300        | M      |           |
| OM4 multimode fiber (bandwidth 4700MHz*km)@25.78Gb/s | L        |       |         | 400        | M      |         4 |
| OM4 multimode fiber (bandwidth 4700MHz*km)@10.3Gb/s  | L        |       |         | 400        | M      |           |

## Notes:

1. IEEE802.3
2. Measured with data rate at 25.78Gbps, PRBS 2 31 -1
3. Measured with data rate at 10.31Gbps, PRBS 2 31 -1
4. This module requires RS-FEC on the host ports for operation at 25G
...
| Parameter                                        | Symbol   |   Min |   Typ |   Max | Unit   | Remarks   |
|--------------------------------------------------|----------|-------|-------|-------|--------|-----------|
| Average Output Optical Power@25.78Gb/s           | P TX     |  -6   |       |   2.4 | dBm    |           |
| Average Output Optical Power@10.3Gb/s            | P TX     |  -7.3 |       |   2.4 | dBm    |           |
| Optical Center Wavelength                        | λ C      | 840   |   850 | 863   | nm     |           |
| Optical Modulation Amplitude@25.78Gb/s           | OMA      |  -6.4 |       |   3   | dBm    |           |
| Optical Modulation Amplitude@10.3Gb/s            | OMA      |  -5.2 |       |   3   | dBm    |           |
| Extinction Ratio@25.78Gb/s                       | ER       |   2   |       |       | dB     |           |
| Extinction Ratio@10.3Gb/s                        | ER       |   3   |       |       | dB     |           |
| Spectral Width (RMS)                             | Δ λ      |       |       |   0.6 | nm     |           |
| Transmitter and Dispersion Eye Closure@25.78Gb/s | TDEC     |       |       |   4.3 | dB     |           |
| Transmitter Dispersion Penalty@10.3Gb/s          | TDP      |       |       |   3.9 | dB     |           |
...
|---------------------------------------|----------|-------|-------|-------|--------|-----------|
| Optical Center Wavelength             | λ C      | 840   |   850 | 863   | nm     |           |
| Average Optical Input Power@25.78Gbps | P RX     |  -8.7 |       |   3   | dBm    |         1 |
| Average Optical Input Power@10.3Gbps  | P RX     |  -9.9 |       |   0.5 | dBm    |         2 |
...
1. Measured with data rate at 25.78Gbps, PRBS 2 31 -1, BER: 5x10 -5 , without fiber
2. Measured with data rate at 10.31Gbps, PRBS 2 31 -1, BER: 1x10 -12
...
| Parameter                 | Symbol   | Min   |   Typ | Max        | Unit   | Remarks   |
|---------------------------|----------|-------|-------|------------|--------|-----------|
| Differential output swing | V OUT PP | 370   |   600 | 850        | mV     |           |
| LOS Assert                | LOS A    | 2     |       | V CC HOST  | V      |           |
| LOS De-Assert             | LOS D    | V EE  |       | V EE + 0.8 | V      |           |

## Digital Diagnostic Functions

SFP-10-25G-CSRsupports the 2-wire serial communication protocol defined in SFF-8472, which accesses digital diagnostic information through a 2-wire interface with the address 0xA2.  The digital diagnosis  defaults  to  internal  calibration,  and  the  internal  micro-control  unit  accesses  the  module operating parameters in real time, such as module temperature, laser bias current, emission power, received light power and module power supply voltage. The module realizes the alarm function of SFF8472, which sets the alarm flag bit when the specific working parameters are out of the normal range, and cancels the alarm flag bit when the specific working parameters return to the normal range.
...
| Tx Power(dBm)     | 5.40(8771h)  | 2.40(43E2h)    | -6.00(09CFh)  | -10.00(03E8h) |
| Rx Power(dBm)     | 5.40(8771h)  | 2.40(43E2h)    | -8.70(0544h)  | -12.70(0219h) |
...
| 2          |      1 | Connector           | Connector Type=LC                            | 07                      |
| 3-10       |      8 | Transceiver         | 25G Base SR                                  | 00 00 00 00 00 00 00 00 |
| 11         |      1 | Encoding            | Code for high speed serial enconding 64B/66B | 06                      |
| 12         |      1 | BR,Nominal          | Nominal Bit Rate 25.78Gbps                   | FF                      |
| 13         |      1 | Rate Identifier     | Type of rate select functionality            | 0C                      |
...
| 18         |      1 | Length(OM4)-10m     | 400m Link Length in OM4 MMF                  | 28                      |
| 19         |      1 | Length(OM3)-10m     | 300m Link Length in OM3 MMF                  | 1E                      |
| 20-35      |     16 | Vendor name         | MODULETEK                                    | ASCII Format            |
| 36         |      1 | Transceiver         | Unallocated                                  | 00                      |
| 37-39      |      3 | Vendor OUI          | SFP Vendor IEEE Company ID                   | 00 00 00                |
| 40-55      |     16 | Vendor PN           | Part number provided by SFP vendor           | ASCII Format            |


| 56-59   |   4 | Vendor rev                 | Revision level for part number provided by vendor                                                                                                                                                                                                                                                                                                                                                                                                                    | Programmed by Factory   |
|---------|-----|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| 60-61   |   2 | Wavelength                 | Laser Wavelength=850nm                                                                                                                                                                                                                                                                                                                                                                                                                                               | 03 52                   |
...
| 65      |   1 | Transceiver Options        | BIT7=0 Receiver decision threshold implemented is not realized BIT6=0 Tunable wavelength lasers are not used BIT5=1 RATE_SELECT functionality is realized BIT4=1 Have TX_DIS function BIT3=1 Have TX_Fault function BIT2=0 Loss of Signal is not realized BIT1=1 Have RX_LOS function BIT0=0 Reserved                                                                                                                                                                | 3A                      |
...
| 93      |   1 | Enhanced Options           | BIT7=1 Have optional Alarm/Warning flags implementes function BIT6=1 Have soft TX_DIS monitor and control functions BIT5=1 Have soft TX_Fault monitor function BIT4=1 Have soft RX_LOS monitor function BIT3=1 Have the software RATE_SELmonitor and control functions BIT2=0 The optional software rate selection control funtion is not implemented by SFF-8079 BIT1=1 The optional soft rate selection control funtion is implemented by SFF-8431 BIT0=0 Reserved | FA                      |
...
| IIC ADDr                 | Size                     | Name                     | Description               | Vaules(HEX)                   |
|--------------------------|--------------------------|--------------------------|---------------------------|-------------------------------|
| Alarm/Warning Thresholds | Alarm/Warning Thresholds | Alarm/Warning Thresholds | Alarm/Warning Thresholds  | Alarm/Warning Thresholds      |
...
| 34-35                                                | 2                                                    | RXPower Low Alarm                                    | RX power low alarm                                             | See The Threshold Range Table                        |
...
| 114                          |                            1 | Tx InputEQ Control           | BIT7-BIT4 Hight-speed mode input equalization setting value; the default value for power-up is 3, which can be used to change the module input equalization value BIT3-BIT0 Low-speed mode input equalization setting value; the default value for power-up is 2 ， which can be used to change the module input equalization value | 32                           |
| 115                          |                            1 | Rx Out Emphasis Control      | BIT7-BIT4 Hight-speed mode output emphasis setting value; the default value for power-up is 3, which can be used to change the module output emphasis value BIT3-BIT0 Low-speed mode output emphasis setting value; the default value for power-up is 2, which can be used to change the module output emphasis value               | 32                           |
...
| 119                | 1                  | Ext Status/Control      | BIT7-BIT5 Unallocated BIT4=0 Not Applicable BIT3=0 Not Applicable BIT2=0 Not Applicable BIT1 If the Tx side CDR is enabled, a value of 0 indicates that the CDR is locked, whereas a value of 1 indicates loss of lock of the CDR. If the CDR is in bypass mode this bit is set to 0 BIT0 If the Rx side CDR is enabled, a value of 0 indicates that the CDR is locked, whereas a value of 1 indicates loss of lock of the CDR. If the CDR is in bypass mode this bit is set to 0 | Variable                       |
...
![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000013_4a33a23bc64ae4c7ef86bb8c0060db39eaff820b9e678c42c80173f5f0436171.png)

## Functions Description

SFP-10-25G-CSR module is manufactured by advanced COB (Chip on Board) technology and consists of a microcontroller, an optical engine at the transmitting end and an optical engine at the receiving end. The module has built-in clock and data recovery functions. If you need another version of the rate range, you can contact us for special customization.
...
Both the transmitter and receiver have the function of suppression. When there is a signal input at the transmitter, the waveform displayed by the transmitted light access oscilloscope is an eye graph shape,


and when there is no signal input, the waveform displayed by the transmitted light access oscilloscope is a straight line, and the actual measured optical power is lower than the normal optical power value, but not zero. When the incident light at the receiving has a signal input, the access oscilloscope shows that the waveform of the output electrical signal is an eye graph shape, and when there is no signal input, the oscilloscope shows that the waveform of the output electrical signal is a straight line.

The  SFP-10-25G-CSR  trancevier  supports  high  data  rates  25.78Gb/s  and  low  data  rates 10.3125Gb/s, CDR at transmitter and receiver are configured according to different signal rates, as shown in the following table:

|   LogicalORof RS0 Pin and Bit110.3 of A2H |   LogicalORof RS1 Pin and Bit118.3 of A2H | RX Signal Rate   | TX Signal Rate   | Status of RX CDR   | Status of TX CDR   |
|-------------------------------------------|-------------------------------------------|------------------|------------------|--------------------|--------------------|
|                                         0 |                                         0 | 9.95-10.31Gb/s   | 9.95-10.31Gb/s   | CDR Bypassed       | CDR Bypassed       |
|                                         0 |                                         1 | 9.95-10.31Gb/s   | 25.2-28.1Gb/s    | CDR Bypassed       | CDR Engaged        |
|                                         1 |                                         0 | 25.2-28.1Gb/s    | 9.95-10.31Gb/s   | CDR Engaged        | CDR Bypassed       |
|                                         1 |                                         1 | 25.2-28.1Gb/s    | 25.2-28.1Gb/s    | CDR Engaged        | CDR Engaged        |
...
![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000016_a27866d52885188bb626015ed867babc8fa0839f3392d37934a19505209da52c.png)
...
![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000018_7a964473df5b87c1d04ede92e2d357dd2b1cb90852f6cf2302177832cfea9a43.png)

![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000019_00b375a50455b8edc782d5c060cf65f31805a59b94c686dced6b15d3f3b8d518.png)

Bottom View Of Board

![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000020_288859e12be4ef6071f10cd01244eafd7ff567cf644732af4821ca97f12a670a.png)

![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000021_ffb15fa4c6093d6395aff1a750f4b3db8c9f30f1b15bdd0f6012f123c862fd9e.png)
...
## Eye View In 25G Working Mode

![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000023_66aa0c62769b87b5ed72327b9369939f96e22bc468614aaea44ab71b4c03adc8.png)

Eye View In 10G Working Mode

![Image](/SFP/SFP-10-25G-CSR/SFP-10-25G-CSR_artifacts/image_000024_33cceaf5fa5deef400849fbe137cd465dd97c914b48c86bb877eb1c358163a76.png)
...
|       7 | RS0        | Receiver rate selection: Open or Low level = 9.95 - 10.31Gb/s rate (low bandwidth) High level = 25.2 - 28.1Gb/s rate (high bandwidth)    |           |
|       8 | LOS        | Loss of Signal indication. Logic 0 indicates normal operation                                                                            |         4 |
|       9 | RS1        | Transmitter rate selection: Open or Low level = 9.95 - 10.31Gb/s rate (low bandwidth) High level = 25.2 - 28.1Gb/s rate (high bandwidth) |           |
...
2. FIBRE CHANNEL Physical Interface-4(FC-PI-4). Rev7.10 September 20, 2007
3. FIBRE CHANNEL Physical Interface-6(FC-PI-6). Rev3.10 October 25, 2013
4.  SFF-8083 SFP+ 1X10 Gb/s Pluggable Transceiver Solution(SFP10). Rev3.1 September 13, 2014
5.  SFF-8402 SFP+ 1X28 Gb/s Pluggable Transceiver Solution(SFP28). Rev1.1 September 13, 2014
6.  SFF-8419 SFP+ Power and Low Speed Interface. Rev1.3 June 11, 2015
7.  SFF-8432 SFP+ Module and Cage. Rev5.2a November 30, 2018
8.  SFF-8472 Management Interface for SFP+. Rev12.3 July 29, 2018