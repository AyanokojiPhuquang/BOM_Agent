...
|---------------|----------------------------------------------------------------|------------------|
| SFP-GE-LX     | GE/FC SFP 1310nm LC Connectors 10km on SMF, with DOM function. | Blue             |
...
| Parameter                    | Symbol   |    Min | Typ   | Max   | Unit   |   Remarks |
|------------------------------|----------|--------|-------|-------|--------|-----------|
| Output Optical Power         | PTX      |   -9.5 |       | - 3   | dBm    |         1 |
| Optical Center Wavelength    | λ C      | 1270   |       | 1355  | nm     |           |
| Optical Modulation Amplitude | OMA      |  174   |       |       | µ W    |         2 |
| Extinction Ratio             | ER       |    9   |       |       | dB     |           |
| Spectral Width (RMS)         | Δ λ      |        |       | 3     | nm     |           |
...
| Total Jitter Contribution          | TJ         |    50 |   120 | ps    |
...
| Parameter                                      | Symbol   |    Min | Typ   |   Max | Unit   | Remarks   |
|------------------------------------------------|----------|--------|-------|-------|--------|-----------|
| Receiver Overload                              | POL      |    0   |       |       | dBm    |           |
| Optical Center Wavelength                      | λ C      | 1260   |       |  1600 | nm     |           |
| Receiver Sensitivity                           | RXSEN    |        |       |   -24 | dBm    |           |
...
| Transmit disable voltage      | V D      | V CC -1.3 |       | VCC        | V      |           |
...
| Parameter                            | Symbol   | Min       |   Typ | Max        | Unit   | Remarks   |
|--------------------------------------|----------|-----------|-------|------------|--------|-----------|
| Single ended data output swing       | VOUT PP  | 300       |   400 | 800        | mV     |           |
| Data output rise/fall time (20%-80%) | t r /t f |           |       | 300        | ps     |           |
| LOS Fault                            | VLOS A   | V CC -0.5 |       | VCC HOST   | V      |           |
| LOS Normal                           | VLOS D   | VEE       |       | V EE + 0.5 | V      |           |

## Digital Diagnostic Functions

SFP-GE-LX  supports  the  2-wire  serial  communication  protocol  as  defined  in  SFP  MSA.  Digital diagnostic information is accessible over the 2-wire interface at the address 0xA2. Digital diagnostics for SFP-GE-LX are internally calibrated by default. The internal micro control unit accesses the device operating  parameters  in  real  time,Such  as  transceiver  temperature,  laser  bias  current,  transmitted optical power, received optical power and transceiver supply voltage.The module implements the alarm function of the SFP MSA ,alerts the user when a particular operating parameter exceeds the factoryset normal range.
...
| Temperature  | Temp                 | ±3                   | ◦ C                  | -40                  | 95                   | ◦ C                  |                      |
| Voltage      | VCC                  | ±0.1                 | V                    | 2.7                  | 3.9                  | V                    |                      |
| Bias Current | Ibias                | ±10                  | %                    | 1                    | 80                   | mA                   |                      |
| Tx Power     | PTX                  | ±3                   | dB                   | -12                  | 0                    | dBm                  |                      |
| Rx Power     | PRX                  | ±3                   | dB                   | -30                  | 0                    | dBm                  |                      |


## Block-Diagram-of-Transceiver

![Image](/SFP/SFP-GE-LX/SFP-GE-LX_artifacts/image_000005_cb823a0b8e07a340fe9f7b98687af5196b45d16466f86065b1caae30c7a7d8bc.png)
...
![Image](/SFP/SFP-GE-LX/SFP-GE-LX_artifacts/image_000007_9022f4be5a4bf0a14b5064ef852cee2d4e738ab88690d5ed6c3037d79b1f863a.png)
