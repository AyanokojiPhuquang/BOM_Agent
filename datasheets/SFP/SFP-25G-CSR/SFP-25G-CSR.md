...
## MODULETEK: SFP-25G-CSR

25.78Gb/s SFP Short Wavelength （ 850nm ） Transceiver

## Overview

SFP-25G-CSR optical transceivers are based on 25G Ethernet IEEE 802.3 standard. They are compliant  with  FC-PI-6 、 SFF-8402 、 SFF-8419 、 SFF-8432 and  SFF-8472,  providing  a  fast  and  reliable interface for 25G Ethernet applications. The product implements the digital diagnostics required by the SFF-8472 via a 2-wire serial bus.

## Product Features

- Up to 25.78Gbps bi-directional data links
...
- Clock data recovery on transmit and receive channels CDR
- Hot-pluggable SFP footprint
- 850nm VCSEL laser transmitter
- Duplex LC connector
- Built-in digital diagnostic functions
- Up to 300m on OM3 MMF and 400m on OM4 MMF
...
![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000001_13c5f1d6a0f74e7ee98372165dbac8401b102aa22178cdd21af3618fdcff9a25.png)
...
|---------------|--------------|-----------------------------------------------------------------------------------------|------------------|
| SFP-25G-CSR   | M008501      | 25GBASE-SR SFP850nm LC Connectors, up to 300m(OM3) or 400m(OM4) on MMF,with DOMfunction | Black            |
...
| Parameter                                  | Symbol   | Min   |   Typ | Max      | Unit   |   Remarks |
|--------------------------------------------|----------|-------|-------|----------|--------|-----------|
| Data rate                                  | DR       |       | 25.78 |          | Gbps   |         1 |
| Bit error rate                             | BER      |       |       | 5x10 - 5 |        |         2 |
| OM3 multimode fiber (bandwidth 2000MHz*km) | L        |       |       | 300      | M      |         3 |
| OM4 multimode fiber (bandwidth 4700MHz*km) | L        |       |       | 400      | M      |         3 |

## Notes:

1. IEEE802.3
2. Measured with data rate at 25.78Gbps, PRBS 2 31 -1
3. This module requires RS-FEC on the host ports for operation at 25G
...
| Parameter                         | Symbol   |   Min |   Typ |   Max | Unit   | Remarks   |
|-----------------------------------|----------|-------|-------|-------|--------|-----------|
| Average Output Optical Power      | P TX     |  -6   |       |   2.4 | dBm    |           |
| Optical Center Wavelength         | λ C      | 840   |   850 | 860   | nm     |           |
| Optical Modulation Amplitude      | OMA      |  -6.4 |       |   3   | dBm    |           |
| Extinction Ratio                  | ER       |   2   |       |       | dB     |           |
| Spectral Width (RMS)              | Δ λ      |       |       |   0.6 | nm     |           |
| Transmitter Dispersion Eye Closed | TDEC     |       |       |   4.3 | dB     |           |
...
|----------------------------------|----------|-------|-------|-------|--------|-----------|
| Optical Center Wavelength        | λ C      | 840   |   850 |   860 | nm     |           |
| Average Receiver Power@25.78Gbps | P RX     |  -8.7 |       |     3 | dBm    |         1 |
...
SFP-25G-CSR supports the 2-wire serial communication protocol defined in SFF-8472, which accesses digital diagnostic information through a 2-wire interface with the address 0xA2.  The digital diagnosis  defaults  to  internal  calibration,  and  the  internal  micro-control  unit  accesses  the  module operating parameters in real time, such as module temperature, laser bias current, emission power, received light power and module power supply voltage. The module realizes the alarm function of SFF8472, which sets the alarm flag bit when the specific working parameters are out of the normal range, and cancels the alarm flag bit when the specific working parameters return to the normal range.
...
SFP-25G-CSR has write protection functions of A0h and A2h, and users can enter the working state of security level 1 and write to the address of module device A0h and table 00h, table 01h and table F0h of A2h. The method to enter the working state of security level 1 is to write the security level 1 password in the 7Bh-7Eh register of the module A2h address in turn. After entering the security level 1, the user can directly write the contents of the A0h device address, or by modifying the contents


of the 7Fh table selection register in the A2h address, write to table 00h or table 01h or table F0h. This version module supports users to modify the password of security level 1 by writing a new security level 1 password in the 80h-83h register in the device address F0h table of module A2h.
...
| 36         |      1 | Transceiver         | 25G Base SR                                       | 02                      |
...
![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000011_3c2864ab1240a405680f5a379286e319cbbe9f12db00bc42eedb38843fc4f55e.png)

## Functions Description

SFP-25G-CSR  module  is  manufactured  by  advanced  COB  (Chip  on  Board)  technology  and consists of a microcontroller, an optical engine at the transmitting end and an optical engine at the receiving end. The module has built-in clock and data recovery functions, and the working rate range of the transmitter and receiver of the built-in CDR is 25.2-28.1Gbps. If you need another version of the rate range, you can contact us for special customization.
...
![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000013_98de87ddfe0d06d7c02036a0934ff464374d37de2490fc372c4e335a76f4b068.png)
...
![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000015_313335b94af146f581812d20c94dfeb250ac637477c157770c167c7df499fa97.png)

![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000016_2140cbe62b08eccba9491c43739ac180c2e766bb3b38b5b43f4d0d971d969bf7.png)

Bottom View Of Board

![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000017_df411e735a5b69fc4ae1a0976632cdc237736efb16245c2ebced34114f8991a9.png)

![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000018_39013d567f720fc02499b12edc791b5c869cda778ad42e01978b08ff06370d63.png)
...
![Image](/SFP/SFP-25G-CSR/SFP-25G-CSR_artifacts/image_000020_14c1d1756aa6a2a394ff95cc3310fcae2b1bc7d8032810c0bdfd68a136421a08.png)
