...
## MODULETEK: SFP-10G-SR-I

10Gb/s SFP+ Short Wavelength (850nm) Transceiver

## SFP-10G-SR-I Overview

ModuleTek's  SFP-10G-SR-I  SFP  optical  transceivers  are  based  on  10G  Ethernet  IEEE  802.3ae standard and SFF-8431 standard, providing a fast and reliable interface for 10G Ethernet applications. The product implements digital diagnostics via a 2-wire serial bus ,compliant with the SFF-8472 standard.
...
![Image](/SFP/SFP-10G-SR-I/SFP-10G-SR-I_artifacts/image_000001_2d2056f8b16a97d46bb636497fbb84af02bf0e266c811ac6a26be871129e8f94.png)
...
|---------------|--------------|------------------------------------------------------------------------------------|------------------|
| SFP-10G-SR    | M242505      | 10GBASE-SR SFP+ 850nm LC 400m on OM4 MMF, with DOM function,Commercial Temperature | black            |
| SFP-10G-SR-E  | M242510      | 10GBASE-SR SFP+ 850nm LC 400m onOM4MMF,withDOM function,Extended Temperature       | black            |
| SFP-10G-SR-I  | M242511      | 10GBASE-SR SFP+ 850nm LC 400monOM4MMF,withDOM function,Industrial Temperature      | black            |
...
| Data Rate        | Fiber Type    |   Modal Bandwidth @850nm (MHz-km) |   Distance Range (m) |
|------------------|---------------|-----------------------------------|----------------------|
| 9.83 - 11.3 Gb/s | 62.5/125umMMF |                               160 |                   26 |
| 9.83 - 11.3 Gb/s | 62.5/125umMMF |                               200 |                   33 |
| 9.83 - 11.3 Gb/s | 50/125umMMF   |                               400 |                   66 |
| 9.83 - 11.3 Gb/s | 50/125umMMF   |                               500 |                   82 |
| 9.83 - 11.3 Gb/s | 50/125umMMF   |                              2000 |                  300 |
| 9.83 - 11.3 Gb/s | 50/125umMMF   |                              4700 |                  400 |
...
| Parameter                       | Symbol      |   Min |   Typ |     Max | Unit   |   Remarks |
|---------------------------------|-------------|-------|-------|---------|--------|-----------|
| Output Optical Power            | P TX        |    -7 |       |   -1    | dBm    |         1 |
| Optical Center Wavelength       | λ C         |   840 |       |  860    | nm     |           |
| Optical Modulation Amplitude    | OMA         |       |  -1.5 |         | dBm    |         2 |
| Extinction Ratio                | ER          |     3 |   5.5 |         | dB     |           |
| Spectral Width (RMS)            | Δ λ         |       |       |    0.45 | nm     |           |
| Relative Intensity Noise        | RIN         |       |       | -128    | dB/Hz  |           |
| Transmitter Dispersion Penalty  | TDP         |       |       |    3.9  | dB     |           |
| Transmitter Jitter              |             |       |       |         |        |         3 |
...
1. Average
2.  IEEE 802.3ae
3.  According to IEEE 802.3ae requirement
...
| 3-10       | 8      | Transceiver            | 10G Base SR                                                                          | 10 00 00 00 00 00 00 00       |
...
| 16         | 1      | Length (50μm)-10m      | 50μm MMF Link Length = 80m                                                           | 08                            |
| 17         | 1      | Length (62.5μm)-10m    | 62.5μmMMF Link Length = 20m                                                          | 02                            |
...
| 64-65      | 2      | Transceiver Options    | 1.Tx_DIS 2.Rx_LOS 3.Tx_FAULT                                                         | 00 1A                         |
|            |        | BR, max                |                                                                                      | 00                            |
| 66 67      | 1 1    | BR, min                | NA NA                                                                                | 00                            |
...
SFP-10G-SR-I  supports  the  2-wire  serial  communication  protocol  as  defined  in  SFF-8472.  Digital diagnostic information is accessible over the 2-wire interface at the address 0xA2. Digital diagnostics for  SFP-10G-SR-I are internally calibrated by default.  The internal micro control unit accesses the device operating parameters in real time,Such as transceiver temperature, laser bias current, transmitted optical power, received optical power and transceiver supply voltage.The module implements the alarm function of the SFF-8472,alerts the user when a particular operating parameter exceeds the factory-set normal range.
...
|                     | E             | 90 (5A 00)        | -10 (F6 00)       | 85 (55 00)          | -5 (FB 00)          |
|                     | I             | 90 (5A 00)        | -45 (D3 00)       | 85 (55 00)          | -40 (D8 00)         |
| Vcc (V)             | Vcc (V)       | 3.63(8D CC)       | 2.97 (74 04)      | 3.46 (87 28)        | 3.13 (7A 44)        |
| Bias (mA)           | Bias (mA)     | 15 (1D 4C)        | 1 (01 F4)         | 12 (17 70)          | 2 (03 E8)           |
| TxPower (dBm)       | TxPower (dBm) | 0.79 (2E E0)      | -7.97 (06 3C)     | 0.0 (27 10)         | -7.0 (07 CB)        |
| RxPower (dBm)       | RxPower (dBm) | 3.01 (4E 20)      | -16.02 (00 FA)    | 0.0 (27 10)         | -13.0 (01 F5)       |

## Block-Diagram-of-Transceiver

![Image](/SFP/SFP-10G-SR-I/SFP-10G-SR-I_artifacts/image_000007_441cf924a96763347e44a5a12269ec32d5a511786fad73ad180ac14b76d5e300.png)
...
![Image](/SFP/SFP-10G-SR-I/SFP-10G-SR-I_artifacts/image_000009_90c432aa90efa463877b4c971d3e45d8e8fc3985e70bb14d7adf6fcf4dceb054.png)

![Image](/SFP/SFP-10G-SR-I/SFP-10G-SR-I_artifacts/image_000010_b8544c90ebbb74377fb3f29bf9bca0c7d89951f0cd28809e1f98e98e4600e823.png)
...
![Image](/SFP/SFP-10G-SR-I/SFP-10G-SR-I_artifacts/image_000012_43f2d8c826d9dcde26668bd6699384f2d5d84f50d1a543e925ed3639ea0c0740.png)
...
![Image](/SFP/SFP-10G-SR-I/SFP-10G-SR-I_artifacts/image_000014_ab6e250b8d8c418571fe1129dd26e36b7fff7036a9c4ccff48b0bba57e0a84a9.png)
